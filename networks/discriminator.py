...
class DINO(torch.nn.Module):
    def __init__(self, hooks: list[int] = [2,5,8,11], hook_patch: bool = True):
        ...
        # load ViT weights
        base_model = timm.create_model('vit_small_patch16_224_dino', pretrained=False)
        base_model.load_state_dict(torch.hub.load_state_dict_from_url(
            "https://github.com/lunit-io/benchmark-ssl-pathology/releases/download/pretrained-weights/dino_vit_small_patch16_ep200.torch"))
